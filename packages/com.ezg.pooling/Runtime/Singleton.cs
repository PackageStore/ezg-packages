...
namespace Ezg.Package.Pooling
{
    ...
    ///     exist. Vendored into this package so the pooling module stays self-contained (no dependency on a host Core
    ///     assembly). The created instance is marked <c>DontDestroyOnLoad</c>, so pooled objects parented under it survive
    ///     scene changes.
    /// </summary>
