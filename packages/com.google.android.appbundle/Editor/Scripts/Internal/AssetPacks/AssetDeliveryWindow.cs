...
namespace Google.Android.AppBundle.Editor.Internal.AssetPacks
{
    public class AssetDeliveryWindow : EditorWindow
    {
        ...
        /// <summary>
        /// Forces the window to reload config from disk on next repaint.
        /// Called by AssetBundleDeliveryTab after syncing the PAD config file.
        /// </summary>
        public void ForceReload()
        {
            _assetDeliveryConfig = null;
            Repaint();
        }
