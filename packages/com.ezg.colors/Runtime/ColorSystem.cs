...
{
    /// <summary>
    /// Utility system for managing and converting colors
    /// </summary>
    public static class ColorSystem
    {
        ...
        /// <summary>
        /// Cached list of default colors
        /// </summary>
        private static List<ColorModel> _colorsDefault;
        ...
        /// <summary>
        /// Gets the list of default colors, initializing it if necessary
        /// </summary>
        public static List<ColorModel> ColorsDefault
        {
            get { return _colorsDefault ?? (_colorsDefault = CreateColorsDefault()); }
        }
        ...
        /// <summary>
        /// Initializes the default color list with standard X11 colors
        /// </summary>
        /// <returns>A list of color models</returns>
        ...
        /// <summary>
        /// Converts a Color32 value to its hexadecimal string representation (RRGGBB)
        /// </summary>
        /// <param name="color">The color to convert</param>
        /// <returns>A 6-character hex string</returns>
        ...
        /// </summary>
        /// <param name="hex">The hex string (e.g., "0xFFFFFF", "#FFFFFF", or "FFFFFF")</param>
        /// <param name="alpha">Optional alpha value (0-255). Defaults to 255 (fully opaque).</param>
        /// <returns>The corresponding Color value</returns>
        public static Color HexToColor(this string hex, byte alpha = 255)
        {
        ...
        /// <summary>
        /// Gets the Color32 value for a specific ColorEnum
        /// </summary>
        /// <param name="color">The color identifier</param>
        /// <returns>The corresponding Color32 value</returns>
        ...
        /// <summary>
        /// Gets the Color32 value from a hex string
        /// </summary>
        ...
        /// <summary>
        /// Wraps a string in Unity <color> tags using a hex color code
        /// </summary>
        /// <param name="str">The string to style</param>
        /// <param name="hex">The hex color code</param>
        /// <returns>The styled string compatible with Unity UI</returns>
        ...
        /// <summary>
        /// Wraps a string in Unity <color> tags using a named color
        /// </summary>
        /// <param name="str">The string to style</param>
        /// <param name="colorStr">The color name or descriptive string</param>
        /// <returns>The styled string compatible with Unity UI</returns>
        ...
        /// <summary>
        /// Wraps a string in Unity <color> tags using a Color object
        /// </summary>
        /// <param name="str">The string to style</param>
        /// <param name="clr">The color object</param>
        /// <returns>The styled string compatible with Unity UI</returns>
        ...
        /// <summary>
        /// Wraps a string in Unity <color> tags using a ColorEnum
        /// </summary>
        /// <param name="str">The string to style</param>
        /// <param name="clr">The color enum identifier</param>
        /// <returns>The styled string compatible with Unity UI</returns>
